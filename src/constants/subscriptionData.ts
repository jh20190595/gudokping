...
export const SUBSCRIPTION_SERVICES: SubscriptionService[] = [
    ...
    },
    {
        ...
        name: '유튜브 프리미엄',
        category: 'OTT',
        logoUrl: '/logos/youtubepremium.png',
    ...
    },
    {
        ...
        name: '유튜브 뮤직',
        category: 'MUSIC',
        logoUrl: '/logos/youtubemusic.png',
    ...
    },
    {
        ...
        name: '네이버 플러스 멤버십',
        category: 'SHOPPING',
        logoUrl: '/logos/navermembership.png',
